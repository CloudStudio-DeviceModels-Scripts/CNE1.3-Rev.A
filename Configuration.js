...
function getEndpoints(deviceAddress, endpoints) {
    ...
    endpoints.addEndpoint("1", "WHP 1.3", endpointType.pressureSensor);
    endpoints.addEndpoint("2", "LP 1.3", endpointType.pressureSensor);
    endpoints.addEndpoint("3", "VALVE_STATUS 1.3", endpointType.appliance, applianceEndpointSubType.valve); 
    endpoints.addEndpoint("4", "LAST_SHUT_IN_HOUR 1.3", endpointType.runTimeMeter);
    endpoints.addEndpoint("5", "SHUT_IN_OPENING_PRE 1.3", endpointType.pressureSensor);
    endpoints.addEndpoint("6", "MAINT_CYCLES_OPENING_PRE 1.3", endpointType.pressureSensor);
    ...
    endpoints.addEndpoint("11", "WHT 1.3", endpointType.temperatureSensor);
    endpoints.addEndpoint("12", "UPSTREAM_PRE 1.3", endpointType.pressureSensor);
    endpoints.addEndpoint("13", "FLOW_REGIME 1.3", endpointType.flowSensor);
    ...
    endpoints.addEndpoint("16", "GAS_FLOW_RATE 1.3", endpointType.flowSensor);
    endpoints.addEndpoint("17", "LIQUID_FLOW_RATE 1.3", endpointType.flowSensor);
    endpoints.addEndpoint("18", "AI1_CONNECTED 1.3", endpointType.appliance);
    endpoints.addEndpoint("19", "AI2_CONNECTED 1.3", endpointType.appliance);
    endpoints.addEndpoint("20", "AI3_CONNECTED 1.3", endpointType.iasSensor);
    var ai4ConnectedEndpoint = endpoints.addEndpoint("21", "AI4_CONNECTED 1.3", endpointType.genericSensor);
